...
protected Collection<Integer> numbers;
	...
	public void removeRepeated() {
		 // без написания дополнительных функций алгоритм сложностью N
	/*	HashSet<Integer> tmp = new HashSet<Integer>(numbers); 
		numbers=tmp;// Так можно перевести все в HashSet - однако меняется структура numbers*/ 
		// БЕЗ ЦИКЛОВ В ДВЕ СТРОЧКИ ПОПРОБОВАТЬ
	...
	public void print() {
		for (Iterator<Integer> iterator = numbers.iterator(); iterator.hasNext();) {
			...
			if (iterator.hasNext()) System.out.print(integer+","); else System.out.println(integer);
		}
	}

	public void changeNumbers(Collection<Integer> numbers) {
