...
public class FireEmployee extends HireEmployee {

	public FireEmployee(int probability) {
		super(probability);
	...
	public void action() {
		...
		int ne = dataProvider.getInteger("getting emplpoyee to fire", 0, size-1);
		Employee man = (Employee) empl.getAllEmployees().get(ne);
		dataProvider.showMessage("Fired manager: "+man);
