...
public class PersonsOrmTestCreation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		Person[] persons = {
				...
				new Employee(128, "David", LocalDate.of(1970, 1, 3), new Address("Beersheva", "Yalim", 3), "Motorola",
						20000),
				new Child(129, "Tolya", LocalDate.of(2010, 5, 3), new Address("Rehovot", "Plaut", 10), "Salut"),
				new Employee(130, "Serg", LocalDate.of(1975, 4, 12), new Address("Beersheva", "Yalim", 3), "Motorola",
						18000) };

			createPersons(persons, personsOrm);
			personsOrm.updateAddress(123, new Address("Rishon Lezion", "Zebotinsky", 20));
